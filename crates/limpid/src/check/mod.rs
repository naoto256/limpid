...
//!
//! Entry point for `limpid --check`. This commit wires:
//!
...
//!   suggestions, `--strict-warnings` (commit 4 / diagnostic UX).
...
/// Byte range into the original source text. Populated by diagnostic UX
...
///
/// `_source` is reserved for diagnostic UX (source snippet rendering with
