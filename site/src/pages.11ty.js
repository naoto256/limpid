...
function content(page) {
  if (page.kind === "home")
    ...
    <p>Version ${release} brings native Windows Event Log input and service operation alongside Linux pipelines. <a href="${url("docs/operations/windows.html")}">Windows requirements and validation boundaries →</a></p>
    <p><a href="${repository}/releases/tag/v${release}">Download Debian packages</a> · <a href="${repository}/releases/download/v${release}/limpid-${release}-x86_64-pc-windows-msvc.zip">Windows x64 ZIP</a> · <a href="${repository}/releases/download/v${release}/limpid-${release}-aarch64-pc-windows-msvc.zip">Windows ARM64 ZIP</a> · <a href="${repository}/releases/download/v${release}/SHA256SUMS">SHA256SUMS</a></p>
