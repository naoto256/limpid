...
function content(page) {
  ...
  return page.kind === "docs"
    ...
    : `<main id="main" class="recipe-detail"><a href="${url("pipelines/")}">← All pipelines</a>${article}</main>`;
}
