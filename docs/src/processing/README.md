...
|---------|---------------|
| Available functions and their signatures | [Built-in Functions](../functions/expression-functions.md) |
...
| Defining a pure value-returning function (`def function`) | [User-defined Functions](../functions/user-defined.md) |
